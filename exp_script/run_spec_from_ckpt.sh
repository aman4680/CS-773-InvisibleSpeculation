...
# Path to the binary you want to simulate
BINARY_PATH="Spectre_variant_1/spectre-demo-main/spectre"
# BINARY_PATH="tests/test-progs/hello/bin/x86/linux/bubblesort"

# Output directory
OUTPUT_DIR=$GEM5_PATH/output/spectre-test
mkdir -p $OUTPUT_DIR
